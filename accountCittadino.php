...
mysql_query("update cittadino set nome='$nome_update',cognome='$cognome_update',mail='$mail_update',password='$password_update' where id=".$_SESSION['id']);
session_start();
       $nome=$_SESSION['nome'];
...
<?php
include "db.php";
    $query=mysql_query("select * from cittadino where id=$idUtente");
...
$password=$result['password'];
        ...
        <form method="POST" action="accountCittadino.php">
